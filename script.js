...
const questions = [
    ...
    },
    {
        ...
        options: ["Dress to Impress", "Driving Simulator", "Doomspire Brickbattle", "Bladeball"],
        answer: "Doomspire Brickbattle"
    },
    {
    ...
    },
    {
        ...
        answer: "March 18"
    } //shoutout to THE kaidan with helping me with the quesitons 
];
...
function checkanswa(selectedOption) {
    ...
    if (currentQuestion < questions.length) {
        ...
        alert(`It's over! Please had enjoyed that Your score is ${score}. Wow!`);
    }
}
